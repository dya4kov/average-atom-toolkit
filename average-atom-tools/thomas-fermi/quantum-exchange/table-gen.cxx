...
void gen_table_cxx(std::string opath, double* data, size_t vSize, size_t tSize) {
	...
	out << "#include <average-atom-tools/thomas-fermi/quantum-exchange/table.h>" << std::endl;
	out << "AATools::TF::QE::Table::Table() : ";
	out << "vSize(" << vSize << "), "
	    << "tSize(" << tSize << "), "
	    << "lgV0(-10.0), "
	    << "lgT0(-10.0), "
	...
	out << "double AATools::TF::QE::Table::operator()(const int& v, const int& t) const {  " << std::endl;
	out << "	return table[v + t*vSize]; " << std::endl;
	out << "} " << std::endl;

	out << "double AATools::TF::QE::Table::operator()(const double& lgV, const double& lgT) const {" << std::endl;
    ...
    out << "double AATools::TF::QE::Table::zeroFit(const double& lgV) const {" << std::endl;
    ...
    out << "std::vector<double> AATools::TF::QE::Table::table({" << std::endl;
