...
void gen_table_cxx(std::string opath, double* data, std::size_t vSize, std::size_t tSize) {
	...
	out << "#include <average-atom-tools/thomas-fermi/thermodynamics/chemical-potential.h>" << std::endl;
    out << "std::vector<double> AATools::TF::ChemicalPotential::table({" << std::endl;
