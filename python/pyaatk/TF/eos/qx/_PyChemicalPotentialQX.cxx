...
private:
    ::aatk::TF::qx::ChemicalPotential M;
};
...
BOOST_PYTHON_MODULE(_PyChemicalPotentialQX) {
    bnp::initialize();

    bpy::class_<py::aatk::TF::qx::ChemicalPotential>("ChemicalPotential")
        
        .def("__call__",        &py::aatk::TF::qx::ChemicalPotential::call_double_double)
        .def("__call__",        &py::aatk::TF::qx::ChemicalPotential::call_double_ndarray)
        .def("__call__",        &py::aatk::TF::qx::ChemicalPotential::call_ndarray_double)
        .def("__call__",        &py::aatk::TF::qx::ChemicalPotential::call_ndarray_ndarray)

        .def("setZ",            &py::aatk::TF::qx::ChemicalPotential::setZ)
        .def("setTolerance",    &py::aatk::TF::qx::ChemicalPotential::setTolerance)
#ifdef ENABLE_MULTITHREADING
        .def("setThreadsLimit", &py::aatk::TF::qx::ChemicalPotential::setThreadsLimit)
#endif
    ;
}