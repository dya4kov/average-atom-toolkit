...
BOOST_PYTHON_MODULE(_PyPotentialQX) {
    bnp::initialize();

    bpy::class_<py::aatk::TF::qx::Potential>("Potential")
        
        .def("__call__",     &py::aatk::TF::qx::Potential::call_ndarray)

        .def("__call__",     &py::aatk::TF::qx::Potential::call_double)

        .def("dx",           &py::aatk::TF::qx::Potential::dx_ndarray)

        .def("dx",           &py::aatk::TF::qx::Potential::dx_double)
        
        .def("setV",         &py::aatk::TF::qx::Potential::setV)

        .def("setT",         &py::aatk::TF::qx::Potential::setT)

        .def("setZ",         &py::aatk::TF::qx::Potential::setZ)

        .def("setVTZ",       &py::aatk::TF::qx::Potential::setVTZ)

        .def("setTolerance", &py::aatk::TF::qx::Potential::setTolerance)
