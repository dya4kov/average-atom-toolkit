...
private:
    ::aatk::TF::QE::ChemicalPotential M;
};
...
BOOST_PYTHON_MODULE(_PyChemicalPotentialQE) {
    bnp::initialize();

    bpy::class_<py::aatk::TF::QE::ChemicalPotential>("ChemicalPotential")
        
        .def("__call__",        &py::aatk::TF::QE::ChemicalPotential::call_double_double)
        .def("__call__",        &py::aatk::TF::QE::ChemicalPotential::call_double_ndarray)
        .def("__call__",        &py::aatk::TF::QE::ChemicalPotential::call_ndarray_double)
        .def("__call__",        &py::aatk::TF::QE::ChemicalPotential::call_ndarray_ndarray)

        .def("setZ",            &py::aatk::TF::QE::ChemicalPotential::setZ)
        .def("setTolerance",    &py::aatk::TF::QE::ChemicalPotential::setTolerance)
        .def("setThreadsLimit", &py::aatk::TF::QE::ChemicalPotential::setThreadsLimit)
    ;
}