...
BOOST_PYTHON_MODULE(_PyFreeEnergyQE) {
    bnp::initialize();

    bpy::class_<py::aatk::TF::QE::FreeEnergy>("FreeEnergy")
        
        .def("__call__",        &py::aatk::TF::QE::FreeEnergy::call_double_double)
        .def("__call__",        &py::aatk::TF::QE::FreeEnergy::call_double_ndarray)
        .def("__call__",        &py::aatk::TF::QE::FreeEnergy::call_ndarray_double)
        .def("__call__",        &py::aatk::TF::QE::FreeEnergy::call_ndarray_ndarray)

        .def("DV",              &py::aatk::TF::QE::FreeEnergy::DV_double_double)
        .def("DV",              &py::aatk::TF::QE::FreeEnergy::DV_double_ndarray)
        .def("DV",              &py::aatk::TF::QE::FreeEnergy::DV_ndarray_double)
        .def("DV",              &py::aatk::TF::QE::FreeEnergy::DV_ndarray_ndarray)

        .def("DT",              &py::aatk::TF::QE::FreeEnergy::DT_double_double)
        .def("DT",              &py::aatk::TF::QE::FreeEnergy::DT_double_ndarray)
        .def("DT",              &py::aatk::TF::QE::FreeEnergy::DT_ndarray_double)
        .def("DT",              &py::aatk::TF::QE::FreeEnergy::DT_ndarray_ndarray)

        .def("D2V",             &py::aatk::TF::QE::FreeEnergy::D2V_double_double)
        .def("D2V",             &py::aatk::TF::QE::FreeEnergy::D2V_double_ndarray)
        .def("D2V",             &py::aatk::TF::QE::FreeEnergy::D2V_ndarray_double)
        .def("D2V",             &py::aatk::TF::QE::FreeEnergy::D2V_ndarray_ndarray)

        .def("DVT",             &py::aatk::TF::QE::FreeEnergy::DVT_double_double)
        .def("DVT",             &py::aatk::TF::QE::FreeEnergy::DVT_double_ndarray)
        .def("DVT",             &py::aatk::TF::QE::FreeEnergy::DVT_ndarray_double)
        .def("DVT",             &py::aatk::TF::QE::FreeEnergy::DVT_ndarray_ndarray)

        .def("D2T",             &py::aatk::TF::QE::FreeEnergy::D2T_double_double)
        .def("D2T",             &py::aatk::TF::QE::FreeEnergy::D2T_double_ndarray)
        .def("D2T",             &py::aatk::TF::QE::FreeEnergy::D2T_ndarray_double)
        .def("D2T",             &py::aatk::TF::QE::FreeEnergy::D2T_ndarray_ndarray)

        .def("setZ",            &py::aatk::TF::QE::FreeEnergy::setZ)
        .def("setTolerance",    &py::aatk::TF::QE::FreeEnergy::setTolerance)
        .def("setThreadsLimit", &py::aatk::TF::QE::FreeEnergy::setThreadsLimit)
    ;
}