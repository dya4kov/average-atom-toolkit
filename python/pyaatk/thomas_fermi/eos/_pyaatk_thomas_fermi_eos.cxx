...
PYBIND11_MODULE(_pyaatk_thomas_fermi_eos, m) {
    ...
    py::class_<aatk::TF::FreeEnergy>(m, "FreeEnergy")
        .def(py::init([](){
            auto F = new aatk::TF::FreeEnergy();
            return F;
        }))

        .def("__call__", [](aatk::TF::FreeEnergy& F, double V, double T) -> double {
            return F(V,T);
        })

        .def("__call__", [api](aatk::TF::FreeEnergy& F, double V, py::array_t<double> T) -> py::array {
            if (T.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. Temperature should be 1D array");
            }
            // get c-array representation
        ...
        .def("__call__", [api](aatk::TF::FreeEnergy& F, py::array_t<double> V, double T) -> py::array {
            if (V.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. Volume should be 1D array");
            }
            // get c-array representation
        ...
        .def("__call__", [api](aatk::TF::FreeEnergy& F, py::array_t<double> V, py::array_t<double> T) -> py::array {
            if (V.ndim() != 1 || T.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. V and T should be 1D arrays");
            }
            // get c-array representation
        ...
        .def("DV", [](aatk::TF::FreeEnergy& F, double V, double T) -> double {
            return F.DV(V,T);
        })

        .def("DV", [api](aatk::TF::FreeEnergy& F, double V, py::array_t<double> T) -> py::array {
            if (T.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. Temperature should be 1D array");
            }
            // get c-array representation
        ...
        .def("DV", [api](aatk::TF::FreeEnergy& F, py::array_t<double> V, double T) -> py::array {
            if (V.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. Volume should be 1D array");
            }
            // get c-array representation
        ...
        .def("DV", [api](aatk::TF::FreeEnergy& F, py::array_t<double> V, py::array_t<double> T) -> py::array {
            if (V.ndim() != 1 || T.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. V and T should be 1D arrays");
            }
            // get c-array representation
        ...
        .def("DT", [](aatk::TF::FreeEnergy& F, double V, double T) -> double {
            return F.DT(V,T);
        })

        .def("DT", [api](aatk::TF::FreeEnergy& F, double V, py::array_t<double> T) -> py::array {
            if (T.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. Temperature should be 1D array");
            }
            // get c-array representation
        ...
        .def("DT", [api](aatk::TF::FreeEnergy& F, py::array_t<double> V, double T) -> py::array {
            if (V.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. Volume should be 1D array");
            }
            // get c-array representation
        ...
        .def("DT", [api](aatk::TF::FreeEnergy& F, py::array_t<double> V, py::array_t<double> T) -> py::array {
            if (V.ndim() != 1 || T.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. V and T should be 1D arrays");
            }
            // get c-array representation
        ...
        .def("D2V", [](aatk::TF::FreeEnergy& F, double V, double T) -> double {
            return F.D2V(V,T);
        })

        .def("D2V", [api](aatk::TF::FreeEnergy& F, double V, py::array_t<double> T) -> py::array {
            if (T.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. Temperature should be 1D array");
            }
            // get c-array representation
        ...
        .def("D2V", [api](aatk::TF::FreeEnergy& F, py::array_t<double> V, double T) -> py::array {
            if (V.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. Volume should be 1D array");
            }
            // get c-array representation
        ...
        .def("D2V", [api](aatk::TF::FreeEnergy& F, py::array_t<double> V, py::array_t<double> T) -> py::array {
            if (V.ndim() != 1 || T.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. V and T should be 1D arrays");
            }
            // get c-array representation
        ...
        .def("DVT", [](aatk::TF::FreeEnergy& F, double V, double T) -> double {
            return F.DVT(V,T);
        })

        .def("DVT", [api](aatk::TF::FreeEnergy& F, double V, py::array_t<double> T) -> py::array {
            if (T.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. Temperature should be 1D array");
            }
            // get c-array representation
        ...
        .def("DVT", [api](aatk::TF::FreeEnergy& F, py::array_t<double> V, double T) -> py::array {
            if (V.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. Volume should be 1D array");
            }
            // get c-array representation
        ...
        .def("DVT", [api](aatk::TF::FreeEnergy& F, py::array_t<double> V, py::array_t<double> T) -> py::array {
            if (V.ndim() != 1 || T.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. V and T should be 1D arrays");
            }
            // get c-array representation
        ...
        .def("D2T", [](aatk::TF::FreeEnergy& F, double V, double T) -> double {
            return F.D2T(V,T);
        })

        .def("D2T", [api](aatk::TF::FreeEnergy& F, double V, py::array_t<double> T) -> py::array {
            if (T.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. Temperature should be 1D array");
            }
            // get c-array representation
        ...
        .def("D2T", [api](aatk::TF::FreeEnergy& F, py::array_t<double> V, double T) -> py::array {
            if (V.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. Volume should be 1D array");
            }
            // get c-array representation
        ...
        .def("D2T", [api](aatk::TF::FreeEnergy& F, py::array_t<double> V, py::array_t<double> T) -> py::array {
            if (V.ndim() != 1 || T.ndim() != 1) {
                throw std::runtime_error("Incorrect number of dimensions. V and T should be 1D arrays");
            }
            // get c-array representation
        ...
        .def("setZ", [](aatk::TF::FreeEnergy& F, double Z) {
            F.setZ(Z);
        })
        .def("setTolerance", [](aatk::TF::FreeEnergy& F, double tol){
            F.setTolerance(tol);
        })
#ifdef ENABLE_MULTITHREADING
        .def("setThreadsLimit", [](aatk::TF::FreeEnergy& F, std::size_t Nthreads) {
