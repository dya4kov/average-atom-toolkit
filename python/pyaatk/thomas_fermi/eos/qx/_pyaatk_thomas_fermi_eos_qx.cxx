...
PYBIND11_MODULE(_pyaatk_thomas_fermi_eos_qx, m) {

    auto& api = py::detail::npy_api::get();

    py::class_<aatk::TF::qx::ChemicalPotential>(m, "ChemicalPotential")
        .def(py::init([](){
            auto M = new aatk::TF::qx::ChemicalPotential();
            return M;
        }))

        .def("__call__", [](aatk::TF::qx::ChemicalPotential& M, double V, double T) -> double {
            return M(V,T);
        })

        .def("__call__", [api](aatk::TF::qx::ChemicalPotential& M, double V, py::array_t<double> T) -> py::array {
            if (T.ndim() != 1) {
        ...
        .def("__call__", [api](aatk::TF::qx::ChemicalPotential& M, py::array_t<double> V, double T) -> py::array {
            if (V.ndim() != 1) {
        ...
        .def("__call__", [api](aatk::TF::qx::ChemicalPotential& M, py::array_t<double> V, py::array_t<double> T) -> py::array {
        ...
        .def("setZ", [](aatk::TF::qx::ChemicalPotential& M, double Z) {
            M.setZ(Z);
        })
        .def("setTolerance", [](aatk::TF::qx::ChemicalPotential& M, double tol){
            M.setTolerance(tol);
        })
#ifdef ENABLE_MULTITHREADING
        .def("setThreadsLimit", [](aatk::TF::qx::ChemicalPotential& M, std::size_t Nthreads) {
