...
struct RHS_int_utf_dntf {
	static const Dimension dim  = 3;

	RHS_int_utf_dntf() : V(1.0), T(1.0), Z(1.0), mu(4.100577730112) {
        rhs = std::bind(&RHS_int_utf_dntf::rhsT, this, _1, _2, _3); eval_a(); eval_r0();
    }
    ...
    void set_T   (const double& _T)   { 
        ...
        T52 = T*T32;
        rhs = T > 1e-10 
                ? std::bind(&RHS_int_utf_dntf::rhsT,  this, _1, _2, _3) 
                : std::bind(&RHS_int_utf_dntf::rhsT0, this, _1, _2, _3);
    }
